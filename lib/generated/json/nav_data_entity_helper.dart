...
navDataEntityFromJson(NavDataEntity data, Map<String, dynamic> json) {
	if (json['data'] != null) {
		data.data = (json['data'] as List).map((v) => NavDataData().fromJson(v)).toList();
	}
	return data;
}

Map<String, dynamic> navDataEntityToJson(NavDataEntity entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
	data['data'] =  entity.data?.map((v) => v.toJson())?.toList();
	return data;
}

navDataDataFromJson(NavDataData data, Map<String, dynamic> json) {
	if (json['articles'] != null) {
		data.articles = (json['articles'] as List).map((v) => NavDataDataArticles().fromJson(v)).toList();
	}
	if (json['cid'] != null) {
...
Map<String, dynamic> navDataDataToJson(NavDataData entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
...
navDataDataArticlesFromJson(NavDataDataArticles data, Map<String, dynamic> json) {
...
Map<String, dynamic> navDataDataArticlesToJson(NavDataDataArticles entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
