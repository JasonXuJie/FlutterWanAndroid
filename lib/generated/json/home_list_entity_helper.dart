...
homeListEntityFromJson(HomeListEntity data, Map<String, dynamic> json) {
	if (json['data'] != null) {
		data.data = HomeListData().fromJson(json['data']);
	}
	return data;
}
...
homeListDataFromJson(HomeListData data, Map<String, dynamic> json) {
	...
	if (json['datas'] != null) {
		data.datas = (json['datas'] as List).map((v) => HomeListDataDatas().fromJson(v)).toList();
	}
	if (json['offset'] != null) {
...
homeListDataDatasFromJson(HomeListDataDatas data, Map<String, dynamic> json) {
