...
authorSearchEntityFromJson(AuthorSearchEntity data, Map<String, dynamic> json) {
	if (json['data'] != null) {
		data.data = AuthorSearchData().fromJson(json['data']);
	}
	return data;
}

Map<String, dynamic> authorSearchEntityToJson(AuthorSearchEntity entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
	data['data'] = entity.data?.toJson();
	return data;
}

authorSearchDataFromJson(AuthorSearchData data, Map<String, dynamic> json) {
	...
	if (json['datas'] != null) {
		data.datas = (json['datas'] as List).map((v) => AuthorSearchDataDatas().fromJson(v)).toList();
	}
	if (json['offset'] != null) {
...
Map<String, dynamic> authorSearchDataToJson(AuthorSearchData entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
...
authorSearchDataDatasFromJson(AuthorSearchDataDatas data, Map<String, dynamic> json) {
	...
	if (json['tags'] != null) {
		data.tags = (json['tags'] as List).map((v) => AuthorSearchDataDatasTags().fromJson(v)).toList();
	}
	if (json['title'] != null) {
...
Map<String, dynamic> authorSearchDataDatasToJson(AuthorSearchDataDatas entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
...
authorSearchDataDatasTagsFromJson(AuthorSearchDataDatasTags data, Map<String, dynamic> json) {
	if (json['name'] != null) {
...
Map<String, dynamic> authorSearchDataDatasTagsToJson(AuthorSearchDataDatasTags entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
