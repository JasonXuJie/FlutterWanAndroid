...
shareOneEntityFromJson(ShareOneEntity data, Map<String, dynamic> json) {
	if (json['data'] != null) {
		data.data = ShareOneData().fromJson(json['data']);
	}
	return data;
}

Map<String, dynamic> shareOneEntityToJson(ShareOneEntity entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
	data['data'] = entity.data?.toJson();
	return data;
}

shareOneDataFromJson(ShareOneData data, Map<String, dynamic> json) {
	if (json['coinInfo'] != null) {
		data.coinInfo = ShareOneDataCoinInfo().fromJson(json['coinInfo']);
	}
	if (json['shareArticles'] != null) {
		data.shareArticles = ShareOneDataShareArticles().fromJson(json['shareArticles']);
	}
	return data;
}

Map<String, dynamic> shareOneDataToJson(ShareOneData entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
...
shareOneDataCoinInfoFromJson(ShareOneDataCoinInfo data, Map<String, dynamic> json) {
...
Map<String, dynamic> shareOneDataCoinInfoToJson(ShareOneDataCoinInfo entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
...
shareOneDataShareArticlesFromJson(ShareOneDataShareArticles data, Map<String, dynamic> json) {
	...
	if (json['datas'] != null) {
		data.datas = (json['datas'] as List).map((v) => ShareOneDataShareArticlesDatas().fromJson(v)).toList();
	}
	if (json['offset'] != null) {
...
Map<String, dynamic> shareOneDataShareArticlesToJson(ShareOneDataShareArticles entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
...
shareOneDataShareArticlesDatasFromJson(ShareOneDataShareArticlesDatas data, Map<String, dynamic> json) {
...
Map<String, dynamic> shareOneDataShareArticlesDatasToJson(ShareOneDataShareArticlesDatas entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
