...
qaEntityFromJson(QaEntity data, Map<String, dynamic> json) {
	if (json['data'] != null) {
		data.data = QaData().fromJson(json['data']);
	}
	return data;
}

Map<String, dynamic> qaEntityToJson(QaEntity entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
	data['data'] = entity.data?.toJson();
	return data;
}

qaDataFromJson(QaData data, Map<String, dynamic> json) {
	...
	if (json['datas'] != null) {
		data.datas = (json['datas'] as List).map((v) => QaDataDatas().fromJson(v)).toList();
	}
	if (json['offset'] != null) {
...
Map<String, dynamic> qaDataToJson(QaData entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
...
qaDataDatasFromJson(QaDataDatas data, Map<String, dynamic> json) {
	...
	if (json['tags'] != null) {
		data.tags = (json['tags'] as List).map((v) => QaDataDatasTags().fromJson(v)).toList();
	}
	if (json['title'] != null) {
...
Map<String, dynamic> qaDataDatasToJson(QaDataDatas entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
...
qaDataDatasTagsFromJson(QaDataDatasTags data, Map<String, dynamic> json) {
	if (json['name'] != null) {
...
Map<String, dynamic> qaDataDatasTagsToJson(QaDataDatasTags entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
