...
topListEntityFromJson(TopListEntity data, Map<String, dynamic> json) {
	if (json['data'] != null) {
		data.data = (json['data'] as List).map((v) => TopListData().fromJson(v)).toList();
	}
	return data;
}

Map<String, dynamic> topListEntityToJson(TopListEntity entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
	data['data'] =  entity.data?.map((v) => v.toJson())?.toList();
	return data;
}

topListDataFromJson(TopListData data, Map<String, dynamic> json) {
...
Map<String, dynamic> topListDataToJson(TopListData entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
