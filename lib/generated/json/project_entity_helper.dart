...
projectEntityFromJson(ProjectEntity data, Map<String, dynamic> json) {
	if (json['data'] != null) {
		data.data = ProjectData().fromJson(json['data']);
	}
	return data;
}
...
projectDataFromJson(ProjectData data, Map<String, dynamic> json) {
	...
	if (json['datas'] != null) {
		data.datas = (json['datas'] as List).map((v) => ProjectDataDatas().fromJson(v)).toList();
	}
	if (json['offset'] != null) {
...
projectDataDatasFromJson(ProjectDataDatas data, Map<String, dynamic> json) {
	...
	if (json['tags'] != null) {
		data.tags = (json['tags'] as List).map((v) => ProjectDataDatasTags().fromJson(v)).toList();
	}
	if (json['title'] != null) {
...
Map<String, dynamic> projectDataDatasToJson(ProjectDataDatas entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
...
projectDataDatasTagsFromJson(ProjectDataDatasTags data, Map<String, dynamic> json) {
	if (json['name'] != null) {
...
Map<String, dynamic> projectDataDatasTagsToJson(ProjectDataDatasTags entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
